...
<header>
  <div class="container b-header__box b-relative">
   ...
   <?php include '../modules/md_nav.php';?>
	</div>
  </div>
</header>
...
<div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
  <div class="b-inner-page-header__content">
	<div class="container">
	  <h1 class="f-primary-l c-default">FAQs</h1>
	</div>
  </div>
</div>
...
<section class="b-infoblock--small">
	...
	<section class="b-infoblock-with-icon-group b-infoblock-with-icon--small-indent row b-infoblock-with-icon--sm f-infoblock-with-icon--sm b-infoblock-with-icon--biggest-icons b-infoblock-with-icon--center f-infoblock-with-icon--center b-default-top-indent">
			<div class="col-md-4 col-sm-6 col-xs-12 b-null-bottom-indent">
				<div class="b-infoblock-with-icon">
					<a href="contact_us_v2.html" class="b-infoblock-with-icon__icon f-infoblock-with-icon__icon fade-in-animate">
