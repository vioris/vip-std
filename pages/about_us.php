...
<section class="b-diagonal-line-bg-light b-infoblock--small ">
    <div class="container">
        <div class="row b-col-default-indent">
            ...
            <div class="col-md-6 col-xs-12">
                <h3 class="f-primary-b">Добро пожаловать на наш сайт</h3>
    ...
    <li><a href="#"><i class="fa fa-check-circle-o b-list-markers__ico f-list-markers__ico"></i> Разработка данных и парсинг</a></li>
</ul>
