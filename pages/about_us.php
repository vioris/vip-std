        ...
        <div class="l-main-container">
                    ...
                    <div class="row b-col-default-indent">
                        ...
                        <div class="col-md-6 col-xs-12">
                            ...
                            <div class="b-btn-container">
                                ...
                                <a href="contact_us.html" class="b-btn f-btn b-btn-md f-btn-md b-btn-default f-primary-b button-blue-light">Смотреть цены</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row b-shortcode-example">
                        <div  data-active="4" class="b-tabs-vertical b-tabs-vertical--default f-tabs-vertical j-tabs-vertical b-tabs-reset row">
                            <div class="col-md-3 col-sm-4 b-tabs-vertical__nav">
                                <ul>
                                    <li><a class="f-primary-l" href="#tabs-1"><i class="fa fa-suitcase"></i> О нас</a></li>
                                    <li><a class="f-primary-l" href="#tabs-2"><i class="fa fa-flask"></i> Наша история</a></li>
                                    <li><a class="f-primary-l" href="#tabs-3"><i class="fa fa-flag"></i> Наша миссия</a></li>
                                    <li><a class="f-primary-l" href="#tabs-4"><i class="fa fa-users"></i> Наши клиенты</a></li>
                                    <li><a class="f-primary-l" href="#tabs-5"><i class="fa fa-home"></i> Наша специализация</a></li>
                                    <li><a class="f-primary-l" href="#tabs-6"><i class="fa fa-comments"></i> Наша команда</a></li>
                                </ul>
                            </div>
            ...
            <section class="b-google-map map-theme">
                ...
                <div class="b-contact-form container">
                    <form class="b-contact-form__window c-primary" type="post" action="#">
