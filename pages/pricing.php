...
<head>
  <meta charset="utf-8">
  <title>About us: Pricing version | Frexy Responsive HTML Template</title>
...
<div class="j-menu-container"></div>
  ...
  <div class="b-inner-page-header__content">
    <div class="container">
      <h1 class="f-primary-l c-default">Таблица Цен</h1>
    </div>
  </div>
</div>
...
<div class="b-breadcrumbs f-breadcrumbs">
    <div class="container">
        <ul>
            ...
            <li><i class="fa fa-angle-right"></i><span>Цены</span></li>
        </ul>
    </div>
</div>
    ...
    <div class="container">
        <div class="row b-col-default-indent">
            <div class="col-md-8 col-md-offset-2">
                <h2 class="f-primary-l f-center c-default">our pricing table</h2>
...
<div class="b-pricing-info__container f-center">
  ...
  <div class="b-pricing-info__item f-pricing-info__item col-sm-6 col-md-3 col-xs-12">
    <div class="b-pricing-info__item-row b-pricing-info__item-title">
      <h4 class="f-primary-b">gold plan</h4>
    </div>
    <div class="b-pricing-info__item-row b-pricing-info__item-price">
