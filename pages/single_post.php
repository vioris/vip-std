...
<html>
    <head>
        <meta charset="utf-8">
        <title> Статья | Viktor P. studio</title>
    ...
    <body>
        ...
        <div class="b-inner-page-header f-inner-page-header b-bg-header-inner-page">
            <div class="b-inner-page-header__content">
                <div class="container">
                    <h1 class="f-primary-l c-default" style="color: #fff;">Статья подробно</h1>
            ...
            <div class="b-breadcrumbs f-breadcrumbs">
                <div class="container">
                    <ul>
                        ...
                        <li><i class="fa fa-angle-right"></i><a href="">Статья</a></li>
                                ...
                                <div data-height="385" class="j-contentwidthslider j-contentwidthslider-innerheight j-pagination-hide">
                                    <ul>
                                        <li data-transition="slotfade-vertical" data-slotamount="25" >
                                            <img data-retina src="../img/slider/slide_content_width_1.jpg">
                                        </li>
