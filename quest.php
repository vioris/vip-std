<section class="b-infoblock--small">
    <div class="container">
        <div class="row b-col-default-indent">
            <div class="col-md-9">
                <h2 class="f-primary-b f-uppercase   c-default" >Часто задаваемые вопросы и ответы</h2>
                <div class="j-accordion b-accordion f-accordion b-accordion--secondary b-accordion--with-icon-indent f-accordion--secondary">
                    <h3 class="b-accordion__title f-accordion__title  f-primary-b " style="text-transform:uppercase;"><i
