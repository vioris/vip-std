    ...
    <section class="container b-welcome-box">
        <div class="row">
            <div class="col-md-offset-2 col-md-8">
                <h2 class="f-primary-l c-default text-center">Мы будем рады Вам помочь.</h2>
                <p class="f-center">Вы можете написать свои пожелания или просьбы.А так же прислать свои предложения, по работе нашего сайта , или по изтоговление продукции по Вашим требованиям. </p>
            </div>
        </div>
    </section>
